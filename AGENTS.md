...
For how this crate is built, where changes belong, and the Pimalaya standards it follows, read `CONTRIBUTING.md` and the `src/lib.rs` header (the crate's architecture document).
